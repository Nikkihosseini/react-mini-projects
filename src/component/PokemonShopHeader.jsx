...
export default function PokemonShopHeader(){
    ...
    return(
        <>
            <div className="fixed right-0 left-0 top-32 flex items-center justify-between w-[90%] border-2 border-neon-blue uppercase text-retro-mint-green p-2 mx-auto z-10 dark:bg-purple-glitch/20 bg-soft-lavender/20 backdrop-blur-md">
