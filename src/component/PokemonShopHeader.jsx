        ...
        <>
            <div className="flex items-center justify-between w-full border-2 border-neon-blue uppercase text-retro-mint-green p-2">
                ...
                <div className="flex items-center justify-end w-36 text-left">
                    <span className="flex items-center text-sm sm:text-base cursor-pointer"><img className="hidden xs:inline-block w-4 h-4 sm:w-6 sm:h-6 mb-2" src="/png-icon/shopping_cart.png" alt="shopping_cart"/>cart:{totalquantity}</span>
                </div>
            </div>
        </>
    )
