...
export default function PokemonShopHeader(){
    ...
    return(
        <>
            <div className="flex items-center justify-between w-[90%] border-2 border-neon-blue uppercase text-retro-mint-green p-2 mx-auto dark:bg-purple-glitch/20 bg-soft-lavender/20 backdrop-blur-md z-40">
