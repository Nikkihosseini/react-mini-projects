        ...
        <>
            ...
            <div className='flex items-start justify-between p-1 w-full bg-neon-blue/10 border-b-2 border-b-neon-blue'>
                <div className='text-left basis-2/3'>
                    ...
                    <h2 className='text-[30px] -mb-2 line-clamp-1'>{pokemonData.name}</h2>
                </div>
            ...
            <div className='flex items-center justify-between h-[227px] w-full border-b-2 border-b-neon-blue'>
